...
// PURPOSE: Sign in / Sign up modal — email+password + Google OAuth
// LAST CHANGED: May 16, 2026
// WHY IT EXISTS: Users need to authenticate to post, answer, vote
// DEPENDENCIES: lib/supabase.js, store/authStore.js
// ⚠️ DO NOT CHANGE: credentials: 'include' on all fetch calls
//                   onAuthStateChange in authStore handles session
//                   Never call getUser() or getSession() here
// ============================================================
...
// --- CHANGE LOG ---
// [May 16, 2026] CREATED: Auth modal — email+password + Google OAuth
// REASON: Users need to sign in / sign up to participate
// --- END CHANGE LOG ---
