...
// WHY IT EXISTS: The ask form needs client-side auth state (onAuthStateChange)
//   and form interactivity. Separated from app/ask/page.js so that page.js
//   can remain a server component and export metadata.
// DEPENDENCIES: lib/supabase.js, react-hot-toast, lucide-react
// ⚠️ DO NOT CHANGE:
...
// Tags the user has typed so far — manages the tag input separately
// so Enter in the tag field adds a tag without submitting the form
    ...
    return (
      <main style={{ maxWidth: '768px', margin: '0 auto', padding: '40px 16px' }}>
        <div className="ask-gate">
          ...
          <p className="ask-gate-body">
            Join the Real Medico community — free to sign up, and your questions help thousands of other healthcare students.
          </p>
          <a href="https://therealmedico.store/sign-in?redirect=https://community.therealmedico.store/ask" className="ask-gate-btn">Sign in to continue</a>
        </div>
      </main>
    )
  }
    ...
    <main style={{ maxWidth: '768px', margin: '0 auto', padding: '40px 16px' }}>
      <div className="ask-header">
        ...
        <p className="ask-page-subtitle">
          Be specific. A good question title and enough context in the body gets faster, better answers.
        </p>
      </div>
      ...
      <div className="ask-form-card">
        ...
        <div className="ask-field">
          <label className="ask-label" htmlFor="ask-title">
            Question title <span className="ask-required">*</span>
          </label>
          <p className="ask-hint">
            Imagine you&apos;re asking a senior colleague in one sentence.
          </p>
          <input
            id="ask-title"
            type="text"
          ...
          <div className="ask-field-footer">
            {errors.title
              ? <span className="ask-error"><AlertCircle size={13} /> {errors.title}</span>
              : <span />
            }
        ...
        {/* ── Body ── */}
        <div className="ask-field">
          <label className="ask-label" htmlFor="ask-body">
            Details <span className="ask-required">*</span>
          </label>
          <p className="ask-hint">
            Include what you already know, where you&apos;re stuck, and any relevant context (patient scenario, exam question, clinical placement, etc.)
          </p>
          <textarea
            id="ask-body"
          ...
          <div className="ask-field-footer">
            {errors.body
              ? <span className="ask-error"><AlertCircle size={13} /> {errors.body}</span>
              : <span />
            }
        ...
        {/* ── Tags ── */}
        <div className="ask-field">
          <label className="ask-label" htmlFor="ask-tags">
            Tags <span className="ask-optional">(optional, up to 5)</span>
          </label>
          <p className="ask-hint">
            Add topics like <strong>pharmacology</strong>, <strong>anatomy</strong>, <strong>paediatrics</strong>. Press Enter or comma to add.
          </p>
            ...
            {tags.map(function renderTag(tag) {
              return (
                <span key={tag} className="ask-tag-chip">
                  ...
                  <button
                    type="button"
                    className="ask-tag-remove"
                    onClick={function handleRemove() { removeTag(tag) }}
        ...
        <div className="ask-submit-row">
          ...
          >
            {submitting
              ? <span className="ask-submitting">Posting...</span>
      ...
      <style>{`
        ...
        .ask-skeleton {
          ...
          animation: askSkeleton 1.4s ease infinite;
          border-radius: 12px;
        }
        ...
        @media (max-width: 600px) {
          .ask-form-card { padding: 20px 16px; }
        }
        ...
        .ask-tag-input-full { border-color: var(--bg-tertiary); }
        .ask-tag-chip {
          display: inline-flex;
          align-items: center;
          gap: 4px;
...
// REASON: Ask a question form. Auth gate for guests. Tag input with chip UI.
//   Validation, char count, rate limit messaging. Redirects to question page on success.
// --- END CHANGE LOG ---
